...
export function CenteredWithLogo() {
  ...
  return (
    <div className="border-t border-border/60 px-8 py-12 bg-background/20 backdrop-blur-sm w-full relative">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex justify-center gap-6 mb-8">
          <Link 
            ...
            className="text-muted-foreground hover:text-[#8B5CF6] transition-colors duration-200"
            aria-label="GitHub"
          >
